 ...
 * @see com.dev.persistence.model.Customer
...
public class CustomerHome {
	...
	public Customer findById(long id) {
		...
		try {
			Customer instance = (Customer) sessionFactory.getCurrentSession().get("com.dev.persistence.model.Customer",
					id);
			if (instance == null) {
	...
	public List findByExample(Customer instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.dev.persistence.model.Customer")
