 ...
 * @see com.dev.persistence.model.Product
...
public class ProductHome {
	...
	public Product findById(long id) {
		...
		try {
			Product instance = (Product) sessionFactory.getCurrentSession().get("com.dev.persistence.model.Product",
					id);
			if (instance == null) {
	...
	public List findByExample(Product instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.dev.persistence.model.Product")
